...
UPDATE_NEED= [[ "$CURRENT_CONFIG_VERSION" == "$LATEST_CONFIG_VERSION" ]] && [[ "$CURRENT_PANEL_VERSION" == "$LATEST_PANEL_VERSION" ]] || echo "*UPDATE AVAILABLE*"
...
WIDTH=70
CHOICE_HEIGHT=12
BACKTITLE="Welcome to Hiddify Panel (config=$CURRENT_CONFIG_VERSION panel=$CURRENT_PANEL_VERSION)              LATEST CONFIG=$LATEST_CONFIG_VERSION $UPDATE_NEED  LATEST PANEL=$LATEST_PANEL_VERSION"
TITLE="Hiddify Panel"
