...
## 欢迎来到 Hiddify-Server 项目
Hiddify-Server 是一个强大而专业的反网络审查工具箱，Hiddify-Server 面板支持多用户，安装简单，<b>支持超过 20 种协议</b>，包括 <b>Reality</b> 和 <b>Telegram 代理 </b>以绕过审查和封锁。它针对<b>中国</b>、<b>俄罗斯</b>和<b>伊朗</b>的审查和封锁规避进行了优化，并得到了<a href="https://github.com/XTLS/Xray-core#installation" target="_blank"><b> Xray </b></a>的推荐。总的来说，它是 X-UI 面板的一个绝佳替代品。
...
### 目录
- [Hiddify-Server 是什么？](#%E4%B8%BA%E4%BB%80%E4%B9%88-hiddify)
...
## Hiddify-Server 是什么？
Hiddify 的名称是 Hidden （隐藏） 和 Simplify （简化） 的合并而来。 Hiddify-Server 是一个具有多特性和多功能的面板，可帮助您享受无忧且安全的互联网浏览。 作为对用户十分友好的 VPN 解决方案，Hiddify-Server 确保您可以轻松、安心地访问自由互联网。
...
您可以使用 Hiddify（Clash） 客户端，或者直接在 Hiddify-Server 面板中，使用以下 3 种模式连接到互联网。
1. 仅通过代理连接被封锁的网站。
...
<details  markdown="1"> <summary>支持的操作系统</summary>
  Hiddify-Server 已经在 Ubuntu 20.04 和 22.04 上进行了测试。支持 Ubuntu arm64 或 amd64 。
</details>
...
我们的服务也需要资金支持。我们所有的活动都是自愿进行的，资金支持将用于项目的开发。您可以在 [此处](https://github.com/hiddify/hiddify-server/wiki/support) 查看我们的支持地址。
