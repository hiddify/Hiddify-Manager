...
ln -sf /opt/hiddify-manager/scripts/hiddify-completion.bash /etc/bash_completion.d/hiddify
ln -sf /opt/hiddify-manager/scripts/hiddify-profile.sh /etc/profile.d/hiddify.sh
